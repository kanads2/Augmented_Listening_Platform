	soc_system u0 (
		.aud_lrclk1_aud_lrclk_clk                        (<connected-to-aud_lrclk1_aud_lrclk_clk>),                        //                 aud_lrclk1_aud_lrclk.clk
		.avalon_microphone_system_0_gpio_din1_new_signal (<connected-to-avalon_microphone_system_0_gpio_din1_new_signal>), // avalon_microphone_system_0_gpio_din1.new_signal
		.avalon_microphone_system_0_gpio_din2_new_signal (<connected-to-avalon_microphone_system_0_gpio_din2_new_signal>), // avalon_microphone_system_0_gpio_din2.new_signal
		.avalon_microphone_system_0_gpio_din3_new_signal (<connected-to-avalon_microphone_system_0_gpio_din3_new_signal>), // avalon_microphone_system_0_gpio_din3.new_signal
		.avalon_microphone_system_0_gpio_din4_new_signal (<connected-to-avalon_microphone_system_0_gpio_din4_new_signal>), // avalon_microphone_system_0_gpio_din4.new_signal
		.bclk_pll_outclk1_clk                            (<connected-to-bclk_pll_outclk1_clk>),                            //                     bclk_pll_outclk1.clk
